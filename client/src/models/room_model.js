...
RoomGenerator.prototype.bindEvents = function(){
  ...
  PubSub.subscribe('DirectionButton:direction-clicked',()=>{
    ...
    switch (content_select_random){
      case 0: var content_select = 'monster';break;
      case 1: var content_select = 'health';break;
      case 2: var content_select = 'upgrade';break;
      default: var content_select = 'null';break;
    };
